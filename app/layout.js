...
export const metadata = {
  metadataBase: new URL('https://www.laffairlounge.kr'),
  title: {
    default: "라페어라운지"
  },
  ...
  openGraph: {
    ...
    url: 'https://www.laffairlounge.kr/',
    siteName: "라페어라운지",
    images: [
      {
  ...
  return (
    <html lang="ko" className={poppins.variable}>
      <head>
        ...
        <meta property="og:image" content="https://www.laffairlounge.kr/Images/main_img/main.webp" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="https://www.laffairlounge.kr/" />
        ...
        <meta name="twitter:image" content="https://www.laffairlounge.kr/Images/main_img/main.webp" />
        <meta name="twitter:domain" content="https://www.laffairlounge.kr/" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "라페어라운지",
              "url": "https://www.laffairlounge.kr",
              "logo": "https://www.laffairlounge.kr/Images/logo.png",
              "image": [
                "https://www.laffairlounge.kr/Images/main_img/main.webp"
              ],
              "description": "라페어라운지 공식 쇼핑몰. 편안하면서도 스타일리시한 속옷, 파자마, 라운지웨어를 만나보세요.",
              "sameAs": [
